...
export default function Form() {
  return (
    <div className='mb-4 '>
      <Card>
       <div className=''>
       <form className='flex items-start pt-2  gap-3 text-slate-500 hover:ring hover:ring-gray-200 p-2 rounded'>
            
            <Profile/>
           <textarea
           placeholder='what is on your mind'
            type='text'
            className='w-[100%]  rounded-md py-2 pl-2 pb-12 grow outline-none'/>
        </form>
